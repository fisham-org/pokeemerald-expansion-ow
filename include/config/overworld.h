...
// NOTE: This romhack does not gate Rock Climb through this config. It is treated as a permanent field move
// like Surf/Waterfall/etc.: its availability is controlled by IsFieldMoveUnlocked_RockClimb() in src/field_move.c
// (currently FLAG_BADGE08_GET). To change when the player can use Rock Climb, edit that unlock function, not this define.
