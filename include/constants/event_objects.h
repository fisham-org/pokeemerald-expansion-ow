...
enum
{
    ...
    // Custom OW trainer-class graphics
    OBJ_EVENT_GFX_LUMBERJACK,
    OBJ_EVENT_GFX_OW_FIRE_BREATHER,
    OBJ_EVENT_GFX_OW_LUMBERJACK_F,
    OBJ_EVENT_GFX_OW_BEEKEEPER_M,
    OBJ_EVENT_GFX_OW_RANGER_M,
    OBJ_EVENT_GFX_OW_RANGER_F,
    OBJ_EVENT_GFX_BUGMANIAC_M,
    OBJ_EVENT_GFX_PARASOLLADY_F,
    OBJ_EVENT_GFX_OW_ENGINEER,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_LUMBERJACK                 0x1134
#define OBJ_EVENT_PAL_TAG_OW_FIRE_BREATHER           0x1135
#define OBJ_EVENT_PAL_TAG_OW_LUMBERJACK_F            0x1136
#define OBJ_EVENT_PAL_TAG_OW_BEEKEEPER_M             0x1137
#define OBJ_EVENT_PAL_TAG_RANGER_M                   0x1138
#define OBJ_EVENT_PAL_TAG_RANGER_F                   0x1139
#define OBJ_EVENT_PAL_TAG_BUGMANIAC_M                0x113A
#define OBJ_EVENT_PAL_TAG_PARASOLLADY_F              0x113B
#define OBJ_EVENT_PAL_TAG_OW_ENGINEER                0x113C
