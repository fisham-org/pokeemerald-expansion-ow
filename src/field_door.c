...
static const u8 sDoorAnimTiles_FloranDoorGreen[] = INCGFX_U8("graphics/door_anims/floran_door_green.png", ".4bpp");
static const u8 sDoorAnimTiles_FloranDoorBrown[] = INCGFX_U8("graphics/door_anims/floran_door_brown.png", ".4bpp");
