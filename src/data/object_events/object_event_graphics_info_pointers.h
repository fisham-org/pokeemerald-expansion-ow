...
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_FirebreatherM;

extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_LumberjackF;
