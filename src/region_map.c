...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_OW_FLORAN] = {MAP_GROUP(MAP_OW_FLORAN), MAP_NUM(MAP_OW_FLORAN), HEAL_LOCATION_POC_FLORAN},
    [MAPSEC_OW_KOLCHAVI] = {MAP_GROUP(MAP_OW_KOLCHAVI), MAP_NUM(MAP_OW_KOLCHAVI), HEAL_LOCATION_KOLCHAVI},
